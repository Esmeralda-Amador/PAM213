...
export default function BotonesScreen()  {
  ...
  const tema=modoOscruro ? styles.darkTheme: styles.lightTheme; //Valor de comparación
  const texto=modoOscruro ? styles.textDark : styles.textLight; //Comparación terniario
    ...
    <View style={[styles.container, tema]}>
      ...
      <Text style={[styles.subtitulo, texto]}>Botones</Text>
        ...
        <View style={styles.buttonContainer}>
          ...
          <Button title="Boton Amarillo" color="#ffc107" onPress={()=>{}} />
