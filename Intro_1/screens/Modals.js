import { Text, StyleSheet, View,Modal,TouchableOpacity,Switch,TextInput,Alert,Platform } from 'react-native'
    ...
    <View style={styles.container}>
      ...
      <View style={styles.modalContenedor}>
        <View style={styles.modalVista}>
          <Text style={styles.modalTitulo}> Pruebas de modal </Text>
          ...
          <View style={styles.switchContenedor}>
            ...
            <Switch trackcolor={{false:'green',true:'white'}}
            thumbColor={gasto ? 'red' : 'green'}
